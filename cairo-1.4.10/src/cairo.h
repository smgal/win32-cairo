...
typedef enum _cairo_operator {
	...
	// ykahn added
	CAIRO_OPERATOR_MULTIPLY = CAIRO_OPERATOR_OVER,
	CAIRO_OPERATOR_SCREEN = CAIRO_OPERATOR_OVER,
	CAIRO_OPERATOR_OVERLAY = CAIRO_OPERATOR_OVER,
	CAIRO_OPERATOR_DARKEN = CAIRO_OPERATOR_OVER,
	CAIRO_OPERATOR_LIGHTEN = CAIRO_OPERATOR_OVER
